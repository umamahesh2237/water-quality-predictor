...
pickle_in = open('C:/Users/HP PC/water-quality-predictor/Water_Quality_Prediction_System.pkl', 'rb')
...
# Making a Prediction with new new water samplepip install scikit-learn==1.2.2
...
def main():
    ...
    st.image("C:/Users/jahnavi/OneDrive/Desktop/4-1 notes/ml & cc ppl/Deployement-of-Automatic-Water-Quality-Prediction-System-on-Streamlit-Cloud/water-testing.jpg")
